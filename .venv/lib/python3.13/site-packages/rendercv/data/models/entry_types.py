...
class ProjectEntryBase(RenderCVBaseModelWithExtraKeys):
    """This class is the parent class of the `ProjectEntry` class."""
...
class ProjectEntry(EntryBase, ProjectEntryBase, EntryType):
    """This class is the data model of `ProjectEntry`."""
...
class ExperienceEntryBase(RenderCVBaseModelWithExtraKeys):
    ...
    projects: Optional[list[ProjectEntry]] = pydantic.Field(
        title="Projects",
    )
